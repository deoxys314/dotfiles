...
-- intentionally global to allow files `require`d later to see this
USER_HOME = os.getenv('HOME') or (os.getenv('homedrive') .. os.getenv('homepath'))
...
require('lazy').setup({
    ...
    },
    {
        ...
        keys = {
            { '<leader>cc', ':CursorChat<CR>', desc = 'Cursor Chat' },
            { '<leader>ce', ':CursorEdit<CR>', mode = { 'n', 'v' }, desc = 'Cursor Edit' },
            { '<leader>cg', ':CursorGenerate<CR>', desc = 'Cursor Generate' },
            { '<leader>cx', ':CursorExplain<CR>', mode = 'v', desc = 'Cursor Explain' },
            { '<leader>cr', ':CursorReview<CR>', desc = 'Cursor Review' },
            { '<leader>co', ':CursorOptimize<CR>', mode = 'v', desc = 'Cursor Optimize' },
            { '<leader>cf', ':CursorFix<CR>', mode = 'v', desc = 'Cursor Fix' },
            { '<leader>crf', ':CursorRefactor<CR>', mode = 'v', desc = 'Cursor Refactor' },
        },
    },
    ...
    },
    {
        ...
        keys = { { '<leader>zx', function() require'hexinspector'.open() end, desc = 'Hex Editor' } },
    ...
    },
    {
        'w0rp/ale',
        version = '*',
        config = function(lz_plug, opts) return require'ale_config'.config() end,
    },
    {
        url = 'https://git.ari.lt/ari/wrapped.vim/',
        name = 'vim-wrapped-2025',
        version = '*',
        config = function(lz_plug, opts) return require'wrapped_config'.config() end,
    },
}, {
    git = { cooldown = 3600 },
